    ...
    if data then
      ...
      table.sort(
        ...
        function(a, b)
          ...
          if a.moduleName == "Blizzard Cooldown Manager" and not a.matchingInfo.matching then
            orderA = orderA - 110
          end
          if b.moduleName == "Blizzard Cooldown Manager" and not b.matchingInfo.matching then
            orderB = orderB - 110
          end
