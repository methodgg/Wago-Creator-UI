...
L["Intro"] = "Intro"
L["altFrameHeader"] = "It appears that you have logged into a new character for the first time.\nWould you like to use the same settings as your first character?"
L["altFrameHeader2"] = "Profiles have been successfully set.\nReload UI now?"
L["altFrameHeader3"] = "Would you like to use the same settings as your first character?"
L["Set all Profiles"] = "Set all Profiles"
