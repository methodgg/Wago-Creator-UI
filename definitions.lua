...
---@field additionalWagoIds table<string, string> | nil Additional X-Wago-IDs for the AddOn. Used for AddOns that have multiple Wago IDs (e.g. BugSack)
...
---@field isProfileStringCompatible? fun(self: LibAddonProfilesModule, profileString: any): boolean Check whether a stored profile string is compatible with this integration. Must not yield.
