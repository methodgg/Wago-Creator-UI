...
L["UI Scale"] = "UI Scale"
L["UISCALE_MANAGE_EXPLAINER"] = "Optional setup step for Intro Wizard users. Enable this module to let users choose from your selected UI Scale values during setup. The step can always be skipped by users."
L["UISCALE_ENABLE_LABEL"] = "Enable Intro Wizard UI Scale setup"
L["UISCALE_ENABLE_HINT"] = "Default is off."
L["UISCALE_OPTION_SECTION_LABEL"] = "UI Scale options users can choose from:"
L["UISCALE_OPTION_INCLUDE_LABEL"] = "Include"
L["UISCALE_OPTION_RECOMMENDED_LABEL"] = "Recommended"
L["UISCALE_OPTION_LABEL"] = "UI Scale %.2f"
L["UISCALE_OPTION_ELVUI_TAG"] = "(ElvUI current)"
L["UISCALE_OPTION_ELVUI_REQUIRED"] = "(requires ElvUI)"
L["UISCALE_ELVUI_REQUIRED_HINT"] = "Scales below 0.64 require ElvUI or a custom AddOn"
...
L["CDM_EXPORT_WARNING"] = "CDM Profiles will only be exported when using the dedicated Export button within this window. They are not automatically exported when clicking the \"Save All Profiles\"-Button in the main window!\nYou must be on the character that has the specified CDM profiles to be able to export them."
