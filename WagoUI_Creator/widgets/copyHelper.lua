...
function addon:CreateCopyHelper()
  ...
  statusBar.bar:SetStatusBarColor(addon.colorRGB.r, addon.colorRGB.g, addon.colorRGB.b)
  ...
  function addon:StartProgressBar(max)
    maxProgress = max
  ...
  function addon:UpdateProgressBar(progress)
    if progress then
